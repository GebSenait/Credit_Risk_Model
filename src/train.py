...
class ModelTrainer:
    ...
    def create_model(self):
        ...
        logger.info(f"Created {self.model_type} model with parameters: {self.model_params}")
...
def main():
    ...
    try:
        ...
        # Initialize trainer
        trainer = ModelTrainer(model_type='random_forest', n_estimators=100, max_depth=10)
